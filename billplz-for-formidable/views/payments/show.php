<div class="wrap">
    ...
    <div id="poststuff" class="metabox-holder has-right-sidebar">
        ...
        <div id="post-body-content">
            ...
            <div class="postbox">
                <div class="handlediv"><br/></div><h3 class="hndle"><span><?php _e('Entry', 'frmbz') ?></span></h3>
                <div class="inside">
                    <table class="form-table"><tbody>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php _e('User', 'frmbz') ?>:</th>
                            <td><?php echo esc_html( $user_name ) ?></td>
                        </tr>
                        
                        <tr valign="top">
                            <th scope="row"><?php _e('Entry', 'frmbz') ?>:</th>
                        ...
                        <tr valign="top">
                            ...
                            <td><?php echo FrmBillplzPaymentsHelper::formatted_amount( $payment ) ?></td>
                        </tr>
                        ...
                        ?>
                        <tr valign="top">
                            <th scope="row"><?php _e('Payment Status Updates', 'frmbz') ?>:</th>
                            <td>
