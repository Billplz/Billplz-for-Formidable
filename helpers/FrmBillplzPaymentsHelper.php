...
class FrmBillplzPaymentsHelper
{
    ...
    public static function get_default_options()
    {
        ...
        return array(
            ...
            'bill_description'  => $frm_payment_settings->settings->bill_description,
            'send_copy_email'   => $frm_payment_settings->settings->send_copy_email,
            'send_copy_mobile'  => $frm_payment_settings->settings->send_copy_mobile,
            ...
            'update_bill_id'    => $frm_payment_settings->settings->update_bill_id,
