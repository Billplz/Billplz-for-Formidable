...
class FrmBillplzPaymentsListHelper extends WP_List_Table
{
    ...
    function no_items()
    {
        _e('No payments found.', 'frmbz');
    }

    function get_columns()
    {
        return FrmBillplzPaymentsController::payment_columns();
    }
    ...
    function display_rows()
    {
        ...
        foreach ($this->items as $item) {
            $item->completed = ( $item->completed ) ? __('Yes', 'frmbz') : __('No', 'frmbz');
            $item->amount = FrmBillplzPaymentsHelper::formatted_amount($item);
            ...
            foreach ($columns as $column_name => $column_display_name) {
                ...
                switch ($column_name) {
                    ...
                    case 'receipt_id':
                        ...
                        $actions = array();
                        $actions['view'] = '<a href="' . esc_url($view_link) . '">' . __('View', 'frmbz') . '</a>';
